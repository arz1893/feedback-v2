...
@section('main-content')
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group pull-right">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="{{ route('product_report_all_year') }}" role="button" class="btn btn-sm btn-info">All Year</a>
                    <a href="{{ route('product_report_yearly') }}" role="button" class="btn btn-sm btn-info">Yearly</a>
                    <a role="button" class="btn btn-sm btn-info">Monthly</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <canvas id="complaint_product_chart_all_year" height="30vh" width="80vw" style="position: relative"></canvas>
@endsection